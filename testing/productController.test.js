	...
	describe('create product', () => {
		test('should return 200 and create product with data product if user is admin', async () => {
			const response = await request(app)
				...
				.send({
					...
					"thumbnail": "https://d29c1z66frfv6c.cloudfront.net/pub/media/catalog/product/large/6e113ad614097a06fc8af5b797f4cb393ef2b03f_xxl-1.jpg",
					"price": 429900,
					"images": [
		...
		test('should return 302 and failed to create product if token is wrong', async () => {
			const response = await request(app)
				...
				.set("Authorization", `Bearer eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpZCI6IjYzMzE3MzNiYzhjNjVmZTkxMDY2MmZlMyIsInVzZXJuYW1lIjoidGVzdCIsImVtYWlsIjoidGVzdEB0ZXN0LmNvbSIsInJvbGUiOiJ1c2VyIiwiaWF0IjoxNjY3NDA3MjUyLCJleHAiOjE2Njc0OTM2NTJ9.IDft7Z9iUc_9ay3Srtpt7Xx9lWaMaqtelmM2hFUS7GE}`)
			expect(response.statusCode).toBe(302);
		})
	});
